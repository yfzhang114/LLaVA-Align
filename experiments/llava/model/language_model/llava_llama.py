...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        cb_cut_weight: Optional[torch.FloatTensor] = None,
        cb_m_weight: Optional[torch.FloatTensor] = None,
        use_calibrate: Optional[bool] = None,
        use_dd: Optional[bool] = None,
        use_dd_unk: Optional[bool] = None,
        images_custom: Optional[torch.FloatTensor] = None,
