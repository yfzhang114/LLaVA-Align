...
--question-file ./data/POPE/${dataset_name}/${dataset_name}_pope_${type}.json \
--image-folder ${image_folder} \
--answers-file ./output/llava15_${dataset_name}_pope_${type}_7b_seed${seed}_vcd.jsonl \
--noise_step $noise_step \
--use_cd \
--cd_alpha $cd_alpha \
--cd_beta $cd_beta \
...
# Set the ground truth file and generated file
python eval/eval_pope.py --gt_files ./data/POPE/coco/coco_pope_random.json --gen_files ./output/llava15_${dataset_name}_pope_${type}_7b_seed${seed}_cd.jsonl