...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="/mnt/workspace/xue.w/yf/VCD/experiments/output/calibrate/llava_mmmu/llava1.5_7b_naive.json", help="The path to model output file.")
