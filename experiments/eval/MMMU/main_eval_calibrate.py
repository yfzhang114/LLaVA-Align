...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="/mnt/workspace/xue.w/yf/VCD/experiments/output/calibrate/llava_mmmu/llava1.5_7b_cd.json", help="The path to model output file.")
    parser.add_argument('--answer_path', type=str, default="/mnt/workspace/xue.w/yf/VCD/experiments/eval/MMMU/answer_dict_val.json", help="Answer file path.")
    args = parser.parse_args()

    print(args)
    output_dict_all = json.load(open(args.output_path))
    answer_dict = json.load(open(args.answer_path))

    for key in output_dict_all.keys():
        output_dict = output_dict_all[key]
        output_dict_w_cat = {}
