...
parser.add_argument("--gt_files", type=str, default="/mnt/data/xue.w/yf/VCD/experiments/data/POPE/coco/coco_pope_adversarial.json")
parser.add_argument("--gen_files", type=str, default="/mnt/data/xue.w/yf/VCD/experiments/output/answer-file-LLAVA-RLHF/llava-v1.5-7b_adversarial.jsonl")
