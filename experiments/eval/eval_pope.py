...
parser.add_argument("--gt_files", type=str, default="/mnt/data/xue.w/yf/VCD/experiments/data/POPE/coco/coco_pope_random.json")
parser.add_argument("--gen_files", type=str, default="/mnt/workspace/xue.w/yf/VCD/experiments/output/llava15_coco_pope_random_7b_seed53.jsonl")
